  ...
  def up
    BlogPost.create(
      ...
      start_content: 
       ...
       <p>Helena has a medically-related academic background, holding a degree in biochemistry and a master’s degree in toxicology. She has worked for the last few years as a research analyst at University of Birmingham. She is passionate about content and about education, and is someone who we'll be proud to have representing us with authors and publishers. Crucially, Helena shares our social vision. She is an entrepreneur who previously set up SightXchange - a social enterprise project which provides eye care and employment in Bangladesh. Helena is a fun, determined and passionate person who we believe will make a massive difference in our team. <p>",
      end_content: "",
