class AddCharlesBlogPost < ActiveRecord::Migration
  def up
    BlogPost.create(
      ...
      start_content:
       "<p>I was chatting to a friend this week who described Charles Care as 'by far the best developer' he'd ever worked with. I then suddenly realised I hadn't written a blog post celebrating about the fact he's about to start working for Meducation! So here it is...</p>
